  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="admin_signup.jsp"><button class="btn btn-success">Sign In/Sign Up</button></a></li>
                <li><a href="logout.jsp"><button class="btn btn-danger">Logout</button></a></li>
