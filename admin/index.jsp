      ...
      <div class="madal-content">
        ...
        <div class="modal-body">
          ...
          <span class="glyphicon glyphicon-envelope"></span>
              ...
              <input type="text" name="mailid" class="form-control input-lg" placeholder="mail id">
          ...
          <span class="glyphicon glyphicon-lock"></span>
            ...
            <div class="form-group">
              <input type="submit" name="b1" class="btn btn-block btn-lg btn-primary" value="Login">
                <span><a href="recoverpass.jsp">Forgot Password</a></span>
            </div>
          </form>
          <div class="modal-footer">
            <div class="col-md-12">
              <a href="/./olx/index.jsp"><button class="btn">Cancel</button></a>
